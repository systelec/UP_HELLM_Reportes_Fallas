<template>
  ...
  >
    <v-btn slot="activator" icon flat @click="valid = ''">
    ...
    <v-card width="600">
      <v-container grid-list-xl fluid>
        <v-layout row wrap>
          ...
          <v-flex xs12>
            <v-layout row wrap>
              <v-btn flat color="blue-grey" @click="dateTimeNow">ACTUAL</v-btn>
              <v-btn flat color="blue-grey" @click="dateTimeNight">NOCHE</v-btn>
              <v-btn flat color="blue-grey" @click="dateTimeAfternoon">TARDE</v-btn>
              <v-btn flat color="blue-grey" @click="dateTimeMorning">MAÑANA</v-btn>
              <v-spacer/>
              <v-btn dark color="blue" @click="save()">APLICAR</v-btn>
            </v-layout>
          </v-flex>
        </v-layout>
      </v-container>
